...
//		new AsyncTaskGetData().execute();
	...
	protected void onDestroy() {
		super.onDestroy();
		System.out.println("AppDefaultActivity被销毁");
	}
...
//			startActivity(intent);
	...
	class AsyncTaskSetModel extends AsyncTask<String, Integer, String>{
		...
		protected void onPostExecute(String result) {
			if(result.equals("")){
				Toast.makeText(AppDefaultActivity.this, "请先获取root权限", Toast.LENGTH_SHORT).show();
				return;
			}
			...
			if(state.equals("ok")){
				...
				MainActivity.tv_showmodel.setText("当前模式:\n"+ "默认模式");// 修改主界面
				Toast.makeText(AppDefaultActivity.this, cpuModel_str+"设置成功", Toast.LENGTH_SHORT).show();
			}else{
				Toast.makeText(AppDefaultActivity.this, cpuModel_str+"设置失败", Toast.LENGTH_SHORT).show();
			}
			////
